...
import io.noizwaves.localemailuniverse.JaysonWebSocketHandler;
...
public class EmailRepositoryMessageListener implements SimpleMessageListener {
    ...
    private final JaysonWebSocketHandler wsHandler;
    private final Session session;

    public EmailRepositoryMessageListener(EmailRepository emailRepository, JaysonWebSocketHandler wsHandler) {
