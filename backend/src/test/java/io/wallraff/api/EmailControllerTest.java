...
public class EmailControllerTest {
    ...
    public void testList() throws Exception {
        when(emailRepository.findByInbox(any())).thenReturn(asList(
                new EmailRecord(1, "foo", "bar", "app", "paz", "baz", "zar", "zoo"),
                new EmailRecord(22, "foo2", "bar2", "app2", "paz2", "baz2", "zar2", "zoo2")
        ));
        ...
        resultActions
                ...
                .andExpect(jsonPath("$[0].bcc", equalTo("paz")))
    ...
    public void testGet() throws Exception {
        when(emailRepository.findOne(1))
                .thenReturn(new EmailRecord(1, "foo", "bar", "app", "paz", "baz", "zar", "zoo"));
        ...
        resultActions
                ...
                .andExpect(jsonPath("$.bcc", equalTo("paz")))
